...
|---------------|------------|------------|---------|---------------|
| delegate-bu1-prod | sqlprod01.bu1.example.internal | 5985 | ✅/❌ | ✅/❌ |
| delegate-bu1-prod | sqlprod02.bu1.example.internal | 5985 | ✅/❌ | ✅/❌ |
...
### Labels
`db-bu1`, `data-quality`, `remediation`
...
### Sub-tasks
1. Inventory merge:
   a. Collect the current per-BU inventory files ([BU_NAME] + affiliates).
