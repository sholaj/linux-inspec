...
title 'CIS Oracle Database 18c Security Compliance Controls'
...
# CIS Oracle Database 18c Benchmark - Installation and Patches
# ==============================================================================

control 'oracle-18c-1.01' do
  impact 1.0
...
# CIS Oracle Database 18c Benchmark - User Accounts
# ==============================================================================

control 'oracle-18c-2.01' do
  impact 1.0
...
# CIS Oracle Database 18c Benchmark - Privileges and Roles
# ==============================================================================

control 'oracle-18c-3.01' do
  impact 1.0
...
# ==============================================================================
# Section 4: Auditing
# CIS Oracle Database 18c Benchmark - Audit Configuration
# ==============================================================================

control 'oracle-18c-4.01' do
  impact 1.0
...
control 'oracle-18c-4.02' do
  impact 1.0
  title 'Ensure unified auditing is enabled'
  desc 'Oracle 18c should use unified auditing for comprehensive audit trail.'
  tag cis: '4.2'
  tag cis_level: 1
  tag severity: 'critical'
...
# CIS Oracle Database 18c Benchmark - Network Security
# ==============================================================================

control 'oracle-18c-5.01' do
  impact 0.8
...
# CIS Oracle Database 18c Benchmark - Password Policies
# ==============================================================================

control 'oracle-18c-6.01' do
  impact 1.0
...
# CIS Oracle Database 18c Benchmark - Data Protection
# ==============================================================================

control 'oracle-18c-7.01' do
  impact 0.8
...
# CIS Oracle Database 18c Benchmark - Listener Configuration
# ==============================================================================

control 'oracle-18c-8.01' do
  impact 0.7
