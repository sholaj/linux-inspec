# MSSQL 2018 InSpec Controls - CIS Microsoft SQL Server 2018 Benchmark v1.3.0
# Version: 3.0.0
# Last Updated: 2026-02-08
#
# This profile implements CIS Microsoft SQL Server 2018 Benchmark controls
# for compliance reporting.
#
# Control ID Format: mssql-2018-X.XX
#
# Note: SQL Server 2018 (vNext/2019 preview) includes CLR Strict Security
# and Machine Learning Services. PolyBase control (2.10) may not apply.
...
control 'mssql-2018-2.09' do
  impact 1.0
  title "Ensure 'External Scripts Enabled' is set to '0'"
  desc 'The external scripts enabled option allows execution of R and Python scripts via Machine Learning Services.'
...
# Note: Control 2.10 (PolyBase) may not be fully applicable to SQL Server 2018

control 'mssql-2018-2.11' do
  impact 0.7
